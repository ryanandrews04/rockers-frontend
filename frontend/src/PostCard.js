        ...
        return (
            <div className="postCard" >
                ...
                <nav className={"postNav"}>
                    ...
                    {this.props.userInfo.token ? (this.props.userInfo.user.id === this.props.post.user_id ? <button onClick={(e) => this.handleEdit(e)}><img className={"editPostBtnImg"} src="https://www.pngitem.com/pimgs/m/114-1146547_new-post-new-post-icon-svg-hd-png.png" /></button> : null) : null}
                </nav>
...

                {
                    this.state.edit
                        ? <form onSubmit={this.submit}>
                            <input type="text" placeholder={"Edit your post here"} onChange={(e) => this.handleUpdatedPost(e.target.value)}></input>
